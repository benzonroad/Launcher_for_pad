...
import com.caoyaui.launcher.DropTarget.DragObject;
import com.caoyaui.launcher.effection.CubeEffectMatrixBuilder;
import com.caoyaui.launcher.effection.CubeInsideEffectMatrixBuilder;
import com.caoyaui.launcher.effection.MoveDeptionEffectionBuilder;
import com.caoyaui.launcher.effection.MoveEffectMatrixBuilder;
import com.caoyaui.launcher.effection.SqueezeEffectMatrixBuilder;
import com.caoyaui.launcher.effection.StreamEffectMatrixBuilder;
import com.caoyaui.launcher.effection.TurnEffectMatrixBuilder;
...
public final class Launcher extends Activity
    ...
    private static final int MENU_GROUP_EDITTING = MENU_GROUP_WALLPAPER+1;
    
    private static final int MENU_GROUP_SLIDING = MENU_GROUP_WALLPAPER + 2;
    ...
    private static final int MENU_EFFECT_OPTIONS = MENU_HELP + 2;
    ...
    void saveEffectToPref(int index) {
    	SharedPreferences pref = getSharedPreferences("com.zhengping.launcher2.prefs",Context.MODE_PRIVATE);
    	Editor editor = pref.edit();
    	editor.putInt(KEY_OF_CURRENT_EFFECT, index);
    	editor.commit();
    }
    ...
    */
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        help.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK
                | Intent.FLAG_ACTIVITY_EXCLUDE_FROM_RECENTS);
        menu.add(MENU_GROUP_EDITTING,MENU_EDIT,0,getString(R.string.edit_model))
        ...
        menu.add(MENU_GROUP_SLIDING,MENU_EFFECT_OPTIONS,0,R.string.menu_effect_option)
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.setGroupVisible(MENU_GROUP_SLIDING, !allAppsVisible);
        menu.setGroupVisible(MENU_GROUP_EDITTING, allAppsVisible && 
        		mAppsCustomizeTabHost.getCurrentTabTag().equals("APPS"));
    	menu.findItem(MENU_EDIT).setChecked(getEditable()?true:false);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_WALLPAPER_SETTINGS:
            ...
            case MENU_EDIT:
            	...
            	return true;
            case MENU_EFFECT_OPTIONS:
            	showEffectionsDialog();
            	return true;
        }
    ...
    public void showEffectionsDialog() {
    	showDialog(DIALOG_SELECT_EFFECTIONS,null);
    }

    public void setEditable(boolean _editable){
    	if(_editable){
    		mDragController.removeDragListener(mWorkspace);
    		mDragController.addDragListener(mAppsCustomizeContent);
    		//mAppsCustomizeContent.setAppCloseIconVisible(_editable);
    		Toast.makeText(this, getString(R.string.enter_edit_model), Toast.LENGTH_SHORT).show();
    	}else{
    		mDragController.removeDragListener(mAppsCustomizeContent);
    		mDragController.addDragListener(mWorkspace);
    		//mAppsCustomizeContent.setAppCloseIconVisible(_editable);
    		Toast.makeText(this, getString(R.string.exit_edit_model), Toast.LENGTH_SHORT).show();
    	}
    	editable = _editable;
    }
    ...
    void addFolder(FolderInfo folderInfo,long container, final int screen, int cellX,
            int cellY){
    	 LauncherModel.addItemToDatabase(Launcher.this, folderInfo, container, screen, cellX, cellY,
                 false);
         sFolders.put(folderInfo.id, folderInfo);
...
//        }
    ...
    void handleFolderClick(FolderIcon folderIcon) {
    ...
    void closeFolder(Folder folder) {
        ...
        if (parent != null) {
            ...
            if(fi == null){
            	fi = (FolderIcon)mAppsCustomizeContent.getViewForTag(folder.mInfo);
            }
   ...
   AppsCustomizePagedView getAppsCustemizePagedView(){
	   return mAppsCustomizeContent;
   }
    
    PagedViewCellLayout getAppPageLayout(FolderIcon icon){
    	if(mAppsCustomizeContent != null){
    		int size = mAppsCustomizeContent.getPageCount();
    		for(int i=0;i<size;i++){
    			View page = mAppsCustomizeContent.getPageAt(i);
    			if(page instanceof PagedViewCellLayout){
    				PagedViewCellLayout layout = (PagedViewCellLayout)page;
    				if(layout.mChildren.indexOfChild(icon) != -1){
        				return layout;
        			}
    			}
    		}
    	}
    	Log.e("xing","not find page contain the FolderIcon"+icon);
    	return null;
    }
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            ...
            case DIALOG_SELECT_EFFECTIONS :
            	return new SelectEffectsDialog().createDialog();
        }

        return super.onCreateDialog(id);
    }
    
    private class SelectEffectsDialog {
    	Dialog createDialog() {
    		AlertDialog.Builder builder = new AlertDialog.Builder(Launcher.this);
    		builder.setTitle(R.string.menu_effect_option)
    		.setSingleChoiceItems(R.array.select_dialog_item2,mCurrentEffectIndex,new DialogInterface.OnClickListener() {
    	...
    	private void cleanUp() {
    		dismissDialog(DIALOG_SELECT_EFFECTIONS);
    	}
    }
    ...
    /* Cling related */
    private static final String PREFS_KEY = "com.caoyaui.launcher.prefs";
            ...
            anim.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animation) {
                    ...
                    SharedPreferences prefs =
                        getSharedPreferences("com.caoyaui.launcher.prefs", Context.MODE_PRIVATE);
